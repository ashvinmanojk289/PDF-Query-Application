...
if user_question:
    ...
    # If vector store is ready, process the question
    if st.session_state.vector_store:
        ...
        with st.chat_message("assistant"):
            st.warning("Please upload and process your PDF documents first.", icon="⚠️")


# --- SIDEBAR FOR FILE UPLOAD ---
with st.sidebar:
    st.title("Menu")
    st.write("Upload your PDF files and click on the 'Process' button.")
